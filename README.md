...
<img src="https://github.com/unfav-ri/blob/master/BAT/disk_check.gif" width="400">

### 3. Login (login.bat)
- Um script para simular um processo de login básico.
<img src="https://github.com/unfav-ri/blob/master/BAT/login.gif" width="400">

### 4. Matrix (matrix.bat)
- Um script que cria um efeito visual semelhante ao código "Matrix" em uma janela de terminal.
<img src="https://github.com/unfav-ri/blob/master/BAT/matrix.gif" width="400">

### 5. Piscando (piscando.bat)
- Um script que faz piscar a tela.
<img src="https://github.com/unfav-ri/blob/master/BAT/piscando.gif" width="400">
...
<img src="https://github.com/unfav-ri/blob/master/BAT/info_do_sistema.gif" width="400">

### 7. Terra (terra.bat)
- Um script que simula uma visualização da terra girando no terminal.
<img src="https://github.com/unfav-ri/blob/master/BAT/terra.gif" width="400">

### 8. TV (tv.bat)
- Um script que simula uma tela de TV sem sinal no terminal.
<img src="https://github.com/unfav-ri/blob/master/BAT/tv.gif" width="400">
